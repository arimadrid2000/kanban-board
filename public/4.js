...
/* harmony default export */ __webpack_exports__["default"] = ({
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              _context.next = 4;
              return _this.createNewCard();

            case 4:
              firstCardsCreated = _context.sent;
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapActions"])('panel', ['loadData', 'createCard'])), {}, {
    ...
    createNewCard: function createNewCard() {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var panelsEmpty, buffer, working, date, day, month, year, end_date, firtsCard, secondCard, resp1, resp2;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                buffer = _this2.panels.find(function (panel) {
                  return panel.name === 'Buffer';
                });
                working = _this2.panels.find(function (panel) {
                  return panel.name === 'Working';
                });
                console.log(_this2.panels);
                date = new Date();
                day = date.getDate();
                month = date.getMonth();
                year = date.getFullYear();
                end_date = "".concat(year, "-").concat(month, "-").concat(day);
                firtsCard = {
                ...
                _context2.next = 15;
                return _this2.createCard(firtsCard);

              case 15:
                resp1 = _context2.sent;
                _context2.next = 18;
                return _this2.createCard(secondCard);
